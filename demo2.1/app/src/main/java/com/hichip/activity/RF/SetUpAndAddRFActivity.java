...
import com.thecamhi.bean.RFDevice;
...
public class SetUpAndAddRFActivity extends HiActivity implements OnClickListener, ICameraIOSessionCallback {
	...
	private List<HiChipDefines.HI_P2P_IPCRF_INFO> list_rf_info = new ArrayList<HiChipDefines.HI_P2P_IPCRF_INFO>();
	...
	private void getData() {
		if (mIsEdit) {
			...
			byte ptzLink = (byte) 0;
			mMyCamera.sendIOCtrl(HiChipDefines.HI_P2P_IPCRF_SINGLE_INFO_GET, HiChipDefines.HI_P2P_IPCRF_INFO.parseContent(index, enable, code, type, name, voiceLink, ptzLink));
		}
	}
