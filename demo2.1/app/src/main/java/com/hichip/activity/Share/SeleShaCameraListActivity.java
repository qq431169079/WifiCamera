		...
		titleView.setNavigationBarButtonListener(new NavigationBarButtonListener() {
			...
			public void OnNavigationButtonClick(int which) {
				...
				case TitleView.NAVIGATION_BUTTON_RIGHT:
					if (HiDataValue.ANDROID_VERSION > 6 && !HiTools.checkPermission(SeleShaCameraListActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
						Toast.makeText(SeleShaCameraListActivity.this, getString(R.string.tips_no_permission), Toast.LENGTH_SHORT).show();
						return;
					}
