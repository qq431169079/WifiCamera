 ...
 * @author lt
 */
public class AlarmSettingActivity extends HiActivity implements ICameraIOSessionCallback, android.widget.CompoundButton.OnCheckedChangeListener, OnCheckedChangeListener {
